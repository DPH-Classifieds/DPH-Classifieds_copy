...
`app.py` 15,813 lines; focused moderation, analytics, diagnostics, sitemap,
...
manifest suites pass; the full backend suite is `1223 passed, 11 skipped,
