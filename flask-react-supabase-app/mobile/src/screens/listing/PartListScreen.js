...
export default function PartListScreen({ navigation }) {
  ...
  const [activeFilters, setActiveFilters] = useState({ condition: '', partType: '', sort: 'Newest', hideReddit: false });
  ...
  const clearFilters = () => {
    const cleared = { condition: '', partType: '', sort: 'Newest', hideReddit: false };
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    cardTitle: { color: colors.textPrimary, fontSize: FONT_SIZES.md, fontWeight: '600', flex: 1, marginRight: 8 },
