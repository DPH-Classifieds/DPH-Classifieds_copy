...
export default function AdminMetricsScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    subSectionTitle: { fontSize: FONT_SIZES.md, fontWeight: '600', color: colors.textPrimary, marginTop: SPACING.md, marginBottom: 4, paddingHorizontal: 4 },
...
function useMetricsStyles() {
  ...
  return useMemo(() => StyleSheet.create({
    ...
    metricLabel: { fontSize: FONT_SIZES.md, color: colors.textPrimary },
    metricNote: { fontSize: FONT_SIZES.xs, color: 'rgba(255,255,255,0.4)', marginTop: 2 },
    metricValue: { fontSize: FONT_SIZES.md, fontWeight: '600', color: colors.textPrimary },
    sectionHeader: { marginBottom: SPACING.sm, marginTop: SPACING.md },
    ...
    healthValue: { fontSize: 16, fontWeight: '700', color: colors.textPrimary, marginTop: 2 },
    barChart: { gap: 6 },
    ...
    chartValue: { width: 36, fontSize: 10, fontWeight: '600', color: colors.textPrimary, textAlign: 'right' },
