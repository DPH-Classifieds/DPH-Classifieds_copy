...
jest.mock('../../utils/apiClient', () => ({
  __esModule: true,
  default: {
    get: jest.fn().mockResolvedValue({ events: [], count: 0 }),
  },
}));
...
const AdminVinOpensScreen = require('../admin/AdminVinOpensScreen').default;
...
test('AdminVinOpensScreen renders LIGHT_COLORS values when theme is light', async () => {
  mockTheme = 'light';
...
test('AdminVinOpensScreen renders DARK_COLORS values when theme is dark', async () => {
  mockTheme = 'dark';
