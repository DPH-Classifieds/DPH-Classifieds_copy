...
export default function DealerLeadDetailScreen({ route }) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    listingTitle: { color: colors.textPrimary, fontSize: FONT_SIZES.lg, fontWeight: '700' },
    ...
    fieldValue: { color: colors.textPrimary, fontSize: FONT_SIZES.sm, fontWeight: '600', flexShrink: 1, textAlign: 'right', textTransform: 'capitalize' },
    ...
    timelineBody: { flex: 1 },
    timelineText: { color: colors.textPrimary, fontSize: FONT_SIZES.sm },
