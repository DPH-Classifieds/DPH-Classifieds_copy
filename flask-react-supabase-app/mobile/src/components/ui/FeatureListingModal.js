...
export default function FeatureListingModal({ visible, listingType, listingId, title, onClose, onCreated }) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    title: { ...FONTS.bold, fontSize: FONT_SIZES.xl, color: colors.textPrimary, marginBottom: SPACING.md },
    ...
    listingTitle: { ...FONTS.medium, fontSize: FONT_SIZES.md, color: colors.textPrimary, marginTop: 2 },
    ...
    input: {
      ...
      color: colors.textPrimary, fontSize: FONT_SIZES.sm, marginBottom: SPACING.md, borderWidth: 1, borderColor: colors.border,
    },
