...
const ActingAsBanner = () => {
  ...
  return (
    <div className="sticky top-0 z-50 h-11 flex items-center justify-between px-5 bg-gradient-to-r from-orange-600 to-rose-600 text-white text-sm font-medium">
