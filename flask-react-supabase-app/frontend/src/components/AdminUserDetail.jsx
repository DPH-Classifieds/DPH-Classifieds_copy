...
import { formatCurrencyAED, formatDate, formatDateTime, formatNumber, getDisplayName, getListingTitle, getStatusTone } from './admin/adminUtils';
          ...
          <table className="admin-table">
            ...
            <tbody>
              {recentEvents.length === 0 ? (
                <tr><td colSpan="3" className="admin-muted">No recent activity found.</td></tr>
