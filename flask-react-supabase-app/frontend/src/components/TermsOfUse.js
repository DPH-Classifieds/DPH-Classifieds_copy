...
const TermsOfUse = () => {
  ...
  return (
    <>
      ...
      <LegalLayout
        eyebrow="Legal"
        title="DPH Classifieds — Platform Terms of Use"
      ...
      >
        ...
        <h2 id="section-1-who-we-are" data-legal-section="section-1-who-we-are">1) Who we are & how to reach us</h2>
        <ul>
        ...
        <h2 id="section-2-changes-to-terms" data-legal-section="section-2-changes-to-terms">2) Changes to these Terms</h2>
        ...
        <h2 id="section-3-changes-to-platform" data-legal-section="section-3-changes-to-platform">3) Changes to the Platform</h2>
        ...
        <h2 id="section-4-privacy" data-legal-section="section-4-privacy">4) Privacy</h2>
        ...
        <h2 id="section-5-licence" data-legal-section="section-5-licence">5) Your licence to use the Platform</h2>
        ...
        <h2 id="section-6-prohibited-use" data-legal-section="section-6-prohibited-use">6) Prohibited use</h2>
        ...
        <h2 id="section-7-accounts" data-legal-section="section-7-accounts">7) Accounts</h2>
        ...
        <h2 id="section-8-paid-services" data-legal-section="section-8-paid-services">8) Paid services</h2>
        ...
        <h2 id="section-9-listings" data-legal-section="section-9-listings">9) Listings & marketplace role</h2>
        ...
        <p><strong>Registration document scanning (OCR).</strong> If you upload a mulkiya, vehicle registration card, or similar document, we may use an automated OCR (optical character recognition) tool to read it and pre-fill Listing fields such as VIN, make, model, and year. This scan is automated, may be inaccurate, and is provided for convenience only — you are solely responsible for verifying and correcting any pre-filled fields before submitting your Listing. By uploading such a document, you consent to us retaining a copy of it and the resulting scan data to train, test, and improve the accuracy of this OCR tool over time, as further described in our Privacy Policy.</p>
        ...
        <h2 id="section-10-reviews" data-legal-section="section-10-reviews">10) Reviews & ratings</h2>
        ...
        <h2 id="section-11-uploaded-content" data-legal-section="section-11-uploaded-content">11) Content you upload</h2>
        <p>Anything you upload or submit (including Listing photos, videos, descriptions, messages, logos, registration/ownership documents, and other media) is non-confidential and non-proprietary as to our use under this licence. You retain ownership of your content, but you grant DPH a perpetual, irrevocable, worldwide, exclusive as to the rights you grant us, royalty-free, transferable, sublicensable, fully paid licence to use, host, store, cache, reproduce, crop, resize, edit, adapt, watermark, publish, translate, create derivative works of, distribute, perform, display, promote, advertise, and otherwise exploit that content, in any media now known or later developed, for any lawful business purpose in connection with operating, improving, moderating, archiving, commercialising, and promoting the Platform and our business.</p>

        <p>This licence includes the right to use listing images, registration/ownership documents, listing data (including prices), and related media that you upload or submit for marketing, editorial, product, archival, moderation, training (including training and improving OCR and other automated tools), testing, analytics, and fraud-prevention purposes, and to keep copies of that content in backups, caches, logs, or archives where reasonably necessary for the operation or protection of the Platform.</p>
        ...
        <h2 id="section-12-aup" data-legal-section="section-12-aup">12) Acceptable Use Policy</h2>
        ...
        <h2 id="section-13-payments" data-legal-section="section-13-payments">13) Payments</h2>
        ...
        <h2 id="section-14-liability" data-legal-section="section-14-liability">14) Disclaimers & limits of liability</h2>
        ...
        <h2 id="section-15-enforcement" data-legal-section="section-15-enforcement">15) Breach & enforcement</h2>
        ...
        <h2 id="section-16-reporting" data-legal-section="section-16-reporting">16) Reporting illegal or infringing content</h2>
        ...
        <h2 id="section-17-general" data-legal-section="section-17-general">17) General terms</h2>
        ...
        <h2 id="section-18-contact" data-legal-section="section-18-contact">18) Contact</h2>
        ...
        <h2 id="annex-a-motors" data-legal-section="annex-a-motors">Annex A — Additional Terms: Motors</h2>
        ...
        <h2 id="linked-policies" data-legal-section="linked-policies">Linked policies & terms (for convenience)</h2>
        <ul>
